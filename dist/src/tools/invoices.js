...
export function registerInvoiceTools(server, client) {
    ...
    server.tool("update_invoice", "Update an existing invoice (only drafts can be edited).", {
        id: z.string().describe("The invoice UUID"),
    ...
    server.tool("delete_invoice", "Delete a draft invoice. This cannot be undone.", {
        id: z.string().describe("The invoice UUID"),
    }, async ({ id }) => {
    ...
    server.tool("add_invoice_line_item", "Add a line item to an invoice.", {
    ...
    server.tool("update_invoice_line_item", "Update a line item on an invoice.", {
        invoice_id: z.string().describe("The invoice UUID"),
    ...
    server.tool("delete_invoice_line_item", "Delete a line item from an invoice.", {
        invoice_id: z.string().describe("The invoice UUID"),
        item_id: z.string().describe("The line item UUID"),
    ...
    server.tool("create_credit_note", "Create a credit note (Gutschrift) for an invoice.", {
    ...
    server.tool("create_cancellation", "Create a cancellation invoice (Stornorechnung) for an invoice.", {
        invoice_id: z.string().describe("The original invoice UUID"),
    }, async ({ invoice_id }) => {
