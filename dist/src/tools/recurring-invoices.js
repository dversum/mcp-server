import { z } from "zod";
export function registerRecurringInvoiceTools(server, client) {
    server.tool("list_recurring_invoices", "List recurring invoice templates.", {
    ...
    server.tool("get_recurring_invoice", "Get details of a recurring invoice template.", {
    ...
    server.tool("create_recurring_invoice", "Create a new recurring invoice template.", {
    ...
    server.tool("update_recurring_invoice", "Update a recurring invoice template.", {
        id: z.string().describe("The recurring invoice UUID"),
    ...
    server.tool("delete_recurring_invoice", "Delete a recurring invoice template.", {
        id: z.string().describe("The recurring invoice UUID"),
    }, async ({ id }) => {
    ...
    server.tool("pause_recurring_invoice", "Pause a recurring invoice (stops auto-generation).", {
        id: z.string().describe("The recurring invoice UUID"),
    }, async ({ id }) => {
    ...
    server.tool("resume_recurring_invoice", "Resume a paused recurring invoice.", {
        id: z.string().describe("The recurring invoice UUID"),
    }, async ({ id }) => {
    ...
    server.tool("generate_recurring_invoice_now", "Manually generate an invoice from a recurring template now.", {
        id: z.string().describe("The recurring invoice UUID"),
    }, async ({ id }) => {
