...
export function registerProjectTools(
  ...
  server.tool(
    "list_projects",
    "List all projects in the organization. Returns projects grouped by area with status and member info.",
    {
  ...
  server.tool(
    "get_project_board",
    "Get the full kanban board for a project — all columns with their tasks, assignees, tags, subtask counts, and time tracked.",
    {
      id: z.string().describe("The project UUID"),
    },
    async ({ id }) => {
  ...
  server.tool(
    ...
    "Get time tracking statistics for a specific project.",
    {
      id: z.string().describe("The project UUID"),
    },
    async ({ id }) => {
  ...
  server.tool(
    "get_gantt_data",
    "Get Gantt chart data for a project (tasks with dates and dependencies).",
    {
      id: z.string().describe("The project UUID"),
    },
    async ({ id }) => {
