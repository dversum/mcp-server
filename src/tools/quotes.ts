...
export function registerQuoteTools(
  ...
  server.tool(
    "list_quotes",
    "List quotes/proposals. Filter by status or client.",
    {
  ...
  server.tool(
    "get_quote",
    "Get detailed information about a quote including line items and totals.",
    {
  ...
  server.tool(
    "delete_quote",
    "Delete a quote. This cannot be undone.",
    {
      id: z.string().describe("The quote UUID"),
    },
    async ({ id }) => {
